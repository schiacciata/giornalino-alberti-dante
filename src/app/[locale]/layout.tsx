		...
		<html lang="en" suppressHydrationWarning>
			...
			<body className="min-h-screen bg-background font-sans antialiased relative flex flex-col">
				<div className="min-h-screen h-full w-full dark:bg-dot-white/[0.2] bg-dot-black/[0.2]">
					<div className="absolute pointer-events-none inset-0 flex items-center justify-center dark:bg-black bg-white mask-[radial-gradient(ellipse_at_center,transparent_60%,black)]"></div>
